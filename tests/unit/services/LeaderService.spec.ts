        ...
        data: {
          fields: {
            ...
            function: {
              ...
              options: {
                options:
                  "Abteilungsleiter, Abteilungsleiterin, Gruppenleiter, Gruppenleiterin, Hilfsleiter, Hilfsleiterin, Materialverantwortlicher, L\\u00e4deliverantwortliche, Homepagebetreuer, Koordination YMCA, Lagerleiter",
              },
            },
            birthyear: {
              name: "birthyear",
