    ...
    return {
      calendarOptions: {
        ...
        events: [
          ...
          { title: 'Pfila Ersatzlager', start: '2020-09-19', end: '2020-09-20' },
...
<template>
  <section class="section">
    <div class="container">
      ...
      <p class="content">
        Die Anlässe werden jeweils Semesterweise publiziert. Im ersten Semester 2020 erwarten uns die untenstehenden Aktivitäten. 
        Wenn Sie mit der Maus darüberfahren Sehen Sie detaillierte Informationen. Sie können die Anlässe auch als <a :href="`${publicPath}files/jungschidaten/2020-2Jungschardaten.pdf`">PDF-Datei herunterladen</a>.
      </p>
